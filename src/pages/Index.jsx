import { Box, Button, Image, Flex, Center, Spacer, useBreakpointValue, VStack, Heading, HStack } from "@chakra-ui/react";
...
const Index = () => {
  ...
  return (
    <Flex direction="column" h="100vh" justify="center" align="center" p={4}>
      ...
      <Button leftIcon={<FaTimes />} rightIcon={<FaArrowRight />} colorScheme="blue" size={buttonSize} mt={8} w="full">
        Skip
      </Button>
    </Flex>
  );
